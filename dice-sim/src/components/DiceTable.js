    ...
    render() {
        return (
                ...
                <Table celled>
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.HeaderCell className="bar-header"><div ref="bar" /></Table.HeaderCell>
                        </Table.Row>
                    </Table.Header>
                    <Table.Body>
            ...
            <div id="info-right">
                ...
                />
                <Pseudocode 
                    resultStep={this.state.resultSteps[this.state.currentresultStep - 1] || this.state.dummyObj}
                    step={this.props.step}
                />
                <TextScroller
                    step={this.props.step}
